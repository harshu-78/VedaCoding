...
const Braceletbanner = () => {
  return (
    <div
      className="swiper-slide relative bg-cover bg-center"
      data-aos="zoom-in"
      data-aos-delay="500"
    >
      {/* Background Video */}
      ...
      >
        <source src="/images/ban3.mp4" type="video/mp4" />
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start justify-between px-4 md:px-24 py-10 md:py-20 min-h-[420px] md:min-h-[530px] text-white">
        <div className="max-w-full md:max-w-[520px] space-y-4 md:space-y-6 animate-bigUp pt-6 md:pt-12">
          ...
          >
            ...
            pandits. Book online puja services and receive divine blessings at
            your doorstep.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-6 mt-4 md:mt-6 w-full">
            <button
              className="bg-red-500 h-10 md:h-12 hover:from-orange-300 hover:to-red-600 text-white
                shadow-lg shadow-red-400/50 hover:shadow-red-500/70 px-6 md:px-10 py-2 md:py-5 rounded-full 
                text-base md:text-lg font-semibold flex items-center gap-2 md:gap-3 transition-all duration-300 
                w-full sm:w-auto"
              data-aos="fade-up"
              data-aos-delay="500"
            >
